grafo = {
    ...
    'São Paulo' : {
        'vizinhos': {
            'Jundiai': {'distancia': 58.8, 'custoPedagio': 11.80, 'tempo': 0.95, 'qualidadeVia': 3, 'qtdPostoPolicial': 3},
            'Guarulhos': {'distancia': 22.0, 'custoPedagio': 0.0, 'tempo': 0.66, 'qualidadeVia': 0, 'qtdPostoPolicial': 6}
        }
    },
